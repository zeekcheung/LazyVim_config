if vim.g.vscode then
  ...
  map("n", "zR", function() call("editor.toggleAll") end)
  ...
  map("n", "<leader>ut", function() call("workbench.action.selectTheme") end)
  map("n", "<leader>up", function() call("workbench.actions.view.problem") end)
  map("n", "<leader>uw", function() call("workbench.action.toggleWordWrap") end)

  -- git
  map("n", "<leader>g", function() call("workbench.scm.focus") end)
